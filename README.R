...
#' 
#' <img src="README_files/F2.large.jpg" width=200/>
#'
#' found in
...
#'
#' The solution is based on building a plot of rectanges (geom_rect) and then
#' displaying the plot using polar coordinates.  The
...
#'
#' Using the diamonds data set from the ggplot2 package we need to build three
#' data.frames (I'll be using data.tables) to summarize the data.
library(data.table)
...
#'    b. No  - end of assessment
#'
#' 2. If the vertebra of interest is in the field of view:, is there a fracture?
#'    a. Yes - go to question 3.
#'    b. No  - end of assessment
#'
#' 3. If the vertebra is fractured, the fracture of type A or B?
#'
#' MRI assessments are considered the "gold standard" and the assessments of the
#' radiographs are compared thereof.
#'
#' A synthetic data set is generated next:
#+ label = "build fracture data"
set.seed(42)
...
#' needed,
#' 1. Not in fov,
#' 2. No fracture (implies in fov),
#' 3. Fracture Type A (implies fracture - implies in fov)
#' 3. Fracture Type B (implies fracture - implies in fov)
#'
...
#' between the rings.  The above graphic has the advantage of each ring holding
